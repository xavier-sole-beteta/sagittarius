...
/**
 * <b>ExportacioExcel</b> implementa les funcionalitats per exportar la predicció de notes a format Excel.<br/>
 * 
...
public class ExportacioExcel {
	...
	private int fila;
	private static final String TITOL = "ECOA - Predicción de notas";
	...
	public void escriuDataSet(Instances dataSet, String titol, int quin, boolean unUnicFull) {
		...
		if(unUnicFull) {
			...
			try {
				fila = 0;
				workbook.createSheet(titol, quin);
