...
/**
 * <b>ExportacioExcel</b> implementa les funcionalitats per exportar els grups de treball a format Excel.<br/>
 * 
...
public class ExportacioExcel {
	...
	private int fila;
	private static final String TITOL = "ECOA - Propuesta de grupos de trabajo";
	...
	public void escriuDataSet(Instances dataSet, String titol, int quin, boolean unUnicFull) {
		String valor = "";

		if(unUnicFull) {
			try {
				addCaption(2, fila, titol.replaceAll("\\'", ""));
				addCaption(2, fila+1, "Expediente");
				addCaption(3, fila+1, "Apellidos");
				addCaption(4, fila+1, "Nombre");
				fila = fila +2;
			...
			try {
				fila = 0;
				workbook.createSheet("GRUPO "+Integer.toString(quin+1), quin);
