...
import sagittarius.controlador.perfils.ControladorPesosAtributs;

import net.miginfocom.swing.MigLayout;

/**
 * <b>DialegPesosAtributs</b> és una finestra per configurar la rellevància
 * de les proves/resultats disponibles.<br/>
 * 
...
public class DialegPesosAtributs extends JDialog {
	...
	public DialegPesosAtributs(int quants, String[] noms, Component vista) {
		...
		jlTitol = new JLabel("Relevancia de las pruebas");
		...
		jlInformacioConfiguracioPerfils.setText("Use los controles para determinar la importància de las pruebas.\nNota: 100 denota una importancia máxima y 0 la mínima.");
		...
		// Panell dels botons
		jpBotons = new JPanel();
		jbCancelar = new JButton("Cancelar", new ImageIcon(ClassLoader.getSystemResource("resources/cancellar.png")));
		jbCancelar.setFocusable(false);
		jbAcceptar = new JButton("Aceptar", new ImageIcon(ClassLoader.getSystemResource("resources/acceptar.png")));
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("resources/Sagittarius-ic.png")));
