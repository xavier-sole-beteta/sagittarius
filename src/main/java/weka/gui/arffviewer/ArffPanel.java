...
public class ArffPanel 
  ...
  public final static String TAB_INSTANCES = "Fitxer carregat";
  ...
  protected void createPanel() {
    ...
    menuItemMean = new JMenuItem("Obtenir mitja...");
    menuItemMean.addActionListener(this);
    menuItemSetAllValues = new JMenuItem("Posar valors a...");
    menuItemSetAllValues.addActionListener(this);
    menuItemSetMissingValues = new JMenuItem("Posar valors desconeguts a...");
    menuItemSetMissingValues.addActionListener(this);
    menuItemReplaceValues = new JMenuItem("Canviar valors per...");
    menuItemReplaceValues.addActionListener(this);
    menuItemRenameAttribute = new JMenuItem("Canviar nom del atribut...");
    ...
    menuItemDeleteAttribute = new JMenuItem("Eliminar atribut...");
    menuItemDeleteAttribute.addActionListener(this);
    menuItemDeleteAttributes = new JMenuItem("Eliminar atributs...");
    menuItemDeleteAttributes.addActionListener(this);
    menuItemSortInstances = new JMenuItem("Ordenar (ascendent)");
    menuItemSortInstances.addActionListener(this);
    menuItemOptimalColWidth = new JMenuItem("Fixar amplada (actual)");
    menuItemOptimalColWidth.addActionListener(this);
    menuItemOptimalColWidths = new JMenuItem("Fixar amplada (tot)");
    menuItemOptimalColWidths.addActionListener(this);

    // row popup
    menuItemUndo = new JMenuItem("Desfer");
    menuItemUndo.addActionListener(this);
    menuItemCopy = new JMenuItem("Copiar");
    menuItemCopy.addActionListener(this);
    menuItemSearch = new JMenuItem("Cercar...");
    menuItemSearch.addActionListener(this);
    menuItemClearSearch = new JMenuItem("Netejar cerca...");
    menuItemClearSearch.addActionListener(this);
    menuItemDeleteSelectedInstance = new JMenuItem("Eliminar (seleccionat)");
    menuItemDeleteSelectedInstance.addActionListener(this);
    menuItemDeleteAllSelectedInstances = new JMenuItem("Eliminar (tots els seleccionats)");
    menuItemDeleteAllSelectedInstances.addActionListener(this);
    
    // table
    m_TableArff = new ArffTable();
    m_TableArff.setToolTipText("Click dret per menu contextual");
    m_TableArff.getTableHeader().addMouseListener(this);
    m_TableArff.getTableHeader().setToolTipText("<html><b>Ordenar:</b> click esquerra = ascendent / Shift + click esquerra = descendent<br><b>Menu:</b> click dret (o esquerra+alt)</html>");
...
/*    if ((model != null) && (model.getInstances() != null))
      m_LabelName.setText("Fitxer: " + model.getInstances().relationName());
    else
      m_LabelName.setText("");*/
  }
  ...
  public void deleteAttribute() {
    ...
    if (ComponentHelper.showMessageBox(
        getParent(), 
        "Confirmar...",
        "Estàs segur d'eliminar l'atribut '" 
  ...
  public void renameAttribute() {
    ...
    newName = ComponentHelper.showInputBox(getParent(), "Canviar nom del atribut...", "Escriu el nom del atribut", model.getAttributeAt(m_CurrentCol).name());
    if (newName == null)
      return;
  ...
  public void search() {
    ...
    // display dialog
    searchString = ComponentHelper.showInputBox(getParent(), "Cercar...", "Entra el text a buscar", m_LastSearch);
